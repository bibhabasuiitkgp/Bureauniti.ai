document.addEventListener('DOMContentLoaded', () => {
    ...
    if (loginForm) {
        loginForm.addEventListener('submit', async (e) => {
            ...
            try {
                const response = await fetch('https://backend-qi7m39sq9-bibhabasu-debnaths-projects.vercel.app/api/login', {
                    method: 'POST',
                    headers: {
    ...
    if (registerForm) {
        registerForm.addEventListener('submit', async (e) => {
            ...
            try {
                const response = await fetch('https://backend-qi7m39sq9-bibhabasu-debnaths-projects.vercel.app/api/register', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                    },
